...
class CustomTestCase(TestCase):
    def assert_fields_required(self, required: bool, form: Any, list_fields: Sequence[str]) -> None:
        """
    ...
    def assert_invalid_data(
        self, form: Any, invalid_data_dicts: Sequence[dict[str, Any]], instance: Any = None, **form_attributes: Any
    ) -> None:
        """
        ...
        for invalid_dict in invalid_data_dicts:
            if instance is not None:
                form_data = form(instance=instance, data=invalid_dict["data"], **form_attributes)
            else:
    ...
    def assert_valid_data(
        self, form: Any, valid_data_dicts: Sequence[dict[str, Any]], instance: Any = None, **form_attributes: Any
    ) -> None:
        """
    ...
    def assert_invalid_data_response(self, url: str, invalid_data_dicts: Sequence[dict[str, Any]]) -> None:
        """
...
class TestUtils:
    """A class with utility methods pertaining to writing tests"""
